...
/**
 * Die grafische Oberfläche der Suche
 * 
...
public class Search_UI extends AbstractWidgetPanel {
	...
	/**
	 * Erzeugt ein neues Objekt der Search_UI mit einem zugehörigen Widget
	 * 
	 * @param parent
				...
				.addKeyListener(new KeyListener() {
					...
					public void keyPressed(KeyEvent arg0) {
						...
						if (arg0.getKeyCode() == 10) {
							search.search(comboBox.getEditor().getItem()
									.toString());
						...
						if (arg0.getKeyCode() == 17) {
							...
							try {
								File f = new File(comboBox.getEditor()
										.getItem().toString());
								if (f.canExecute()) {
									desktop.open(f);
								}
